// *******************************************************************************
//   Custom DPA Handler code example - LEDR on                                   *
// *******************************************************************************
// Copyright (c) IQRF Tech s.r.o.
//
// File:    $RCSfile: CustomDpaHandler-LED-Red-On.c,v $
...
bit CustomDpaHandler()
{
  ...
  {
    _DpaMessage.EnumPeripheralsAnswer.HWPID = 0xDDDF;
    _DpaMessage.EnumPeripheralsAnswer.HWPIDver = 0xDDDF;
    return TRUE;
  }
